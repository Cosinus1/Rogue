...
public class GameScreen implements Screen {
   ...
   public void render(float delta) {
      ...
      // Store last position (need delay so that Hero doesnt spawn too close from
      // door)
   ...
   public void dispose() {
      ...
      // It's also a good practice to dispose of the maps and their renderers if they
      // were created and loaded within this class
      if (map != null) {
